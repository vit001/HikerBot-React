...
var Authentication_createUser_args = function(args) {
...
var Authentication_createUser_result = function(args) {
  this.success = null;
...
var Authentication_authenticate_args = function(args) {
  this.googleIdToken = null;
  if (args) {
    if (args.googleIdToken !== undefined && args.googleIdToken !== null) {
      this.googleIdToken = args.googleIdToken;
...
var Authentication_authenticate_result = function(args) {
  this.success = null;
  this.userException = null;
  this.systemException = null;
  if (args instanceof Errors_ttypes.HAMPUserException) {
...
var Authentication_submitNonLoggedInRegID_args = function(args) {
...
var Authentication_submitNonLoggedInRegID_result = function(args) {
  this.success = null;
  this.userException = null;
  this.systemException = null;
  this.notFoundException = null;
...
var AuthenticationClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
var AuthenticationProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.createUser.length === 2) {
    Q.fcall(this._handler.createUser, args.googleIdToken, args.user)
      .then(function(result) {
        var result_obj = new Authentication_createUser_result({success: result});
        ...
        if (err instanceof Errors_ttypes.HAMPUserException || err instanceof Errors_ttypes.HAMPSystemException || err instanceof Errors_ttypes.HAMPNotFoundException) {
          result = new Authentication_createUser_result(err);
          output.writeMessageBegin("createUser", Thrift.MessageType.REPLY, seqid);
        } else {
    ...
    this._handler.createUser(args.googleIdToken, args.user, function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined') || err instanceof Errors_ttypes.HAMPUserException || err instanceof Errors_ttypes.HAMPSystemException || err instanceof Errors_ttypes.HAMPNotFoundException) {
        result_obj = new Authentication_createUser_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("createUser", Thrift.MessageType.REPLY, seqid);
      } else {
...
AuthenticationProcessor.prototype.process_authenticate = function(seqid, input, output) {
  ...
  if (this._handler.authenticate.length === 1) {
    Q.fcall(this._handler.authenticate, args.googleIdToken)
      .then(function(result) {
        var result_obj = new Authentication_authenticate_result({success: result});
        ...
        if (err instanceof Errors_ttypes.HAMPUserException || err instanceof Errors_ttypes.HAMPSystemException) {
          result = new Authentication_authenticate_result(err);
          output.writeMessageBegin("authenticate", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.authenticate(args.googleIdToken, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Errors_ttypes.HAMPUserException || err instanceof Errors_ttypes.HAMPSystemException) {
        result_obj = new Authentication_authenticate_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("authenticate", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("authenticate", Thrift.MessageType.EXCEPTION, seqid);
...
AuthenticationProcessor.prototype.process_submitNonLoggedInRegID = function(seqid, input, output) {
  ...
  if (this._handler.submitNonLoggedInRegID.length === 1) {
    Q.fcall(this._handler.submitNonLoggedInRegID, args.registrationID)
      .then(function(result) {
        var result_obj = new Authentication_submitNonLoggedInRegID_result({success: result});
        ...
        var result;
        if (err instanceof Errors_ttypes.HAMPUserException || err instanceof Errors_ttypes.HAMPSystemException || err instanceof Errors_ttypes.HAMPNotFoundException) {
          result = new Authentication_submitNonLoggedInRegID_result(err);
          output.writeMessageBegin("submitNonLoggedInRegID", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.submitNonLoggedInRegID(args.registrationID, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Errors_ttypes.HAMPUserException || err instanceof Errors_ttypes.HAMPSystemException || err instanceof Errors_ttypes.HAMPNotFoundException) {
        result_obj = new Authentication_submitNonLoggedInRegID_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("submitNonLoggedInRegID", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("submitNonLoggedInRegID", Thrift.MessageType.EXCEPTION, seqid);
